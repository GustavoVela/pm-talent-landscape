...
│
├── data/                       # 📊 Datasets y taxonomías
│   └── skills/                 #    Mapeo de habilidades crudas → categorías estandarizadas
│       ├── ai_skills_grouping.md           # IA: 30 categorías (GenAI, LLMs, Agentic AI...)
│       ├── business_skills_grouping.md     # Negocios: finanzas, revenue, partnerships...
│       ├── core_pm_skills_grouping.md      # Core PM: 20 categorías (roadmapping, discovery...)
│       ├── data_skills_grouping.md         # Datos: SQL, Python, analytics tools...
│       ├── technical_skills_grouping.md    # Técnico: APIs, cloud, arquitectura...
│       └── ux_ui_skills_grouping.md        # UX/UI: Figma, research, design systems...
│
├── hooks/                      # 🪝 Custom hooks
