...
export function AiIndustryChart() {
    ...
    <div className="flex flex-col w-full">
      ...
      {filteredData.length > 0 ? (
        ...
        <div className="w-full h-[450px] flex items-center justify-center border border-dashed border-border/50 bg-muted/20 rounded-lg mt-4">
          <p className="text-muted-foreground text-sm font-medium">No hay sectores que cumplan con este criterio.</p>
        </div>
      )}
    </div>
  );
