        ...
        <div className="mx-auto max-w-5xl">
          ...
          <NarrativeText>
            ...
            <ul className="list-disc pl-5 space-y-4 my-6">
              ...
              <li><strong>La paridad técnica es el dato contraintuitivo — y lo que se pide no es lo mismo.</strong> La diferencia en el dominio Técnico entre EE. UU. (39.7%) y Latinoamérica (38.0%) es de apenas 1.7 puntos. Sin embargo, al revisar las habilidades individuales, la naturaleza de la demanda diverge profundamente. En EE. UU., las habilidades técnicas más solicitadas son APIs (9.1%), arquitectura de sistemas, cloud (AWS 2.5%, Azure 1.7%, GCP 1.0%) y plataformas de datos modernas como Snowflake o Databricks. En Latinoamérica, SQL lidera con 8.9% frente al 4.6% en EE. UU. Esta divergencia es consistente con la lógica de la "máquina del tiempo": no es que la competencia analítica desaparezca en mercados maduros —al contrario, en EE. UU. la demanda de análisis cuantitativo abstracto (Data Analysis 23.4%) supera ampliamente a LATAM (12.8%)—, sino que las <em>habilidades específicas de bajo nivel</em> que la soportan cambian. En mercados donde la infraestructura de datos ya está construida (dashboards, plataformas de analítica, equipos de Data Science dedicados), el PM no necesita extraer datos directamente con SQL; necesita interpretarlos. En Latinoamérica, donde esa infraestructura aún está en construcción en muchas empresas, el mercado solicita que el propio PM pueda consultar directamente la fuente. La evidencia apoya esta lectura, aunque no la confirma de forma definitiva.</li>
