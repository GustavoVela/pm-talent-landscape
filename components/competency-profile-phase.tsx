        ...
        <div className="mx-auto max-w-5xl">
          ...
          <NarrativeText>
            ...
            <ul className="space-y-4 my-6">
              ...
              <li><strong>El perfil Unicornio es minoritario — y lo piden empresas muy específicas.</strong> Solo el <strong>8.8%</strong> de las publicaciones en EE. UU. y el <strong>5.3%</strong> en Latinoamérica incluyen simultáneamente los cinco dominios. Contra la intuición, no son principalmente startups: en EE. UU. este perfil aparece en empresas como Meta, BetterUp, Pinterest, Automation Anywhere o Samba TV. En Latinoamérica, lo solicitan mayoritariamente empresas brasileras (Serasa Experian, Creditas, Bees Brasil, AgileEngine) y algunas chilenas (Banco Falabella, Global66). El patrón sugiere que son empresas con productos digitales complejos —fintechs, plataformas de datos, empresas de tecnología empresarial— que buscan optimizar headcount cubriendo máltiples frentes en un solo rol, no necesariamente el modelo de contratación dominante del mercado.</li>
            </ul>
          </NarrativeText>
